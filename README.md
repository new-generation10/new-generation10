...
Серков Ростислав, 18 лет.

- Развиваюсь в направлении DevOps и backend-разработки на Python/Django.
- Работаю с Linux, Docker, Kubernetes, Git, знаком с базовыми процессами CI/CD, а также с основами HTML/CSS.
- Ищу возможности расти как Junior DevOps Engineer, углубляя навыки автоматизации, развёртывания и сопровождения сервисов.
